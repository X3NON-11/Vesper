...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "prerelease_0.941"
  WORKING_DIRECTORY "/home/xenon/PROJECTS/cpp/vesper/examples/example1/build/_deps/vesper-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "prerelease_0.941")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("prerelease_0.941" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: prerelease_0.941")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/prerelease_0.941")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"prerelease_0.941\" is not present locally, and not "
